...
# Kernel
BOARD_KERNEL_CMDLINE := printk.devkmsg=on service_locator.enable=1 usbcore.autosuspend=7 user_debug=31 androidboot.hardware=qcom loop.max_part=7
BOARD_KERNEL_CMDLINE := androidboot.init_fatal_reboot_target=recovery ehci-hcd.park=3 kpti=off lpm_levels.sleep_disabled=1 msm_rtb.filter=0x37
BOARD_KERNEL_CMDLINE :=  androidboot.boot_devices=soc/c0c4000.sdhci androidboot.configfs=true androidboot.usbcontroller=a800000.dwc3
